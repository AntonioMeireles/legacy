...
#
# Properly update to the closed source nvidia drivers
#
...
echo -n "Are you sure you want to switch to the nVidia drivers? (y/n)"
read confirm

if [ $confirm == "Y" ] || [ $confirm == "y" ];# || $confirm == "y" ];
then
    echo "Switching to the nVidia Binary (Closed Source Driver)"
