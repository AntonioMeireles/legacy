...
#
# Properly update to the closed source ati-fglrx drivers
#
...
echo -n "Are you sure you want to switch to the ati-fglrx drivers? (y/n)"
read confirm

if [ $confirm == "Y" ] || [ $confirm == "y" ];# || $confirm == "y" ];
then
    echo "Switching to the ATI Binary (Closed Source Driver)"
